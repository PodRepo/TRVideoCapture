...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_resource "../../Resources/capture_bg@2x.png"
  ...
  install_resource "../../Resources/capture_up@2x.png"
  install_resource "../../Resources/capture_video_longvideo_btn_shoot@2x.png"
  install_resource "../../Resources/CaptureViewController.xib"
fi
